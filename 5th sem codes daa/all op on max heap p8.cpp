...
void insert_key(int arr[]){
	...
	printf("\n");
	printf("enter the value(ele) to be inserted: ");
	scanf("%d",&key);
	n++;
	arr[n-1]=-99999999;
...
void increase_key(int arr[]){
	...
	printf("\n");
	printf("enter the id of the value to be increased: ");
	scanf("%d",&id);
	printf("\nenter the increased value: ");
	scanf("%d",&key);
	if(arr[id]>key){
		printf("\nerror,the val present at id is already increased\n");
	}
	else{
		increase(arr,key,id);
	}
...
void decrease_key(int arr[]){
	...
	printf("\n");
	printf("enter the id of the value to be decreased: ");
	scanf("%d",&id);
	printf("\nenter the decreased value: ");
	scanf("%d",&key);
	if(arr[id]<key){
		printf("\nerror,the val present at id is already decreased\n");
	}
	else{
		arr[id]=key;
		max_heapify(arr,id);
...
void delete_key(int arr[]){
	...
	printf("\n");
	printf("enter the id of the value to be deleted: ");
	scanf("%d",&id);
	int del_ele=arr[id];
	arr[id]=arr[n-1];
	n--;
