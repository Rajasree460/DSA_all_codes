...
int main()
{
	...
	int a1[5][5],b1[5][5],sum[5][5],subtract1[5][5],res[5][5],trans_mat[5][5];
...
void add()
{
	int i,j,row_sum,col_sum,row1,row2,col1,col2;
...
void sub()
{
	int i,j,row_sub,col_sub,row1,row2,col1,col2;
...
void multiply()
{
	int i,j,k,res_row,res_col,row1,row2,col1,col2;
