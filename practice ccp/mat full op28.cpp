...
int main()
{
	...
	printf("enter the no of row for 1st mat\n");
	scanf("%d",&row1);
	printf("enter the no of col for 1st mat\n");
	scanf("%d",&col1);
	printf("enter the no of row for 2nd mat\n");
	scanf("%d",&row2);
	printf("enter the no of col for 2nd mat\n");
	scanf("%d",&col2);
	while(ch!=5)
	{
		printf("main menu\n");
...
void subtract(int a[][5],int b[][5],int sub[][5],int row1,int col1,int row2,int col2)
{
	...
	if(row1==row2 && col1==col2)
	{
		...
		printf("the result of subtract is\n")
		for(i=0;i<row_sub;i++)
		{
			printf("\n");
			for(j=0;j<col_sub;j++)
...
void multiplay(int a[][5],int b[][5],int res[][5],int row1,int col1,int row2,int col2)
{
	...
	if(col1==row2)
	{
		...
		printf("the result of multiplay is\n");
		for(i=0;i<res_row;i++)
		{
			printf("\n");
			for(j=0;j<res_col;j++)
